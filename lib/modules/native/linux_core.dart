...
class LinuxNativeEngine implements NativeEngine {
  ...
  Future<Map<String, dynamic>> translateExcel({
    ...
    return {'success': false, 'error': 'Xử lý Excel chưa được hỗ trợ trên Linux'};
  }
  ...
  Future<Map<String, dynamic>> translateDocx({
    ...
    return {'success': false, 'error': 'Xử lý Word chưa được hỗ trợ trên Linux'};
  }
  ...
  Future<Map<String, dynamic>> translatePdf({
    ...
    return {'success': false, 'error': 'Xử lý PDF chưa được hỗ trợ trên Linux'};
  }
  ...
  Future<Map<String, dynamic>> translatePptx({
    ...
    return {'success': false, 'error': 'Xử lý PowerPoint chưa được hỗ trợ trên Linux'};
  }

  @override
  Future<Map<String, dynamic>> performOCR({required String imagePath}) async {
    return {'success': false, 'error': 'OCR chưa được hỗ trợ trên Linux'};
  }
}
